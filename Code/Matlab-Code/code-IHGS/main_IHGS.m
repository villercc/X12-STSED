...
Function_name='F23'; % Name of the test function, range from F1-F13

FEs=100; % Maximum number of evaluation times

dimSize = 4;   %dimension size

% Load details of the selected benchmark function
[lb,ub,dim,fobj]=Get_Functions_IHGS(Function_name,dimSize); 

[Destination_fitness,bestPositions,Convergence_curve]=IHGS(N,FEs,lb,ub,dim,fobj);
