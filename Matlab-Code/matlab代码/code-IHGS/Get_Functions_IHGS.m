...
function [lb,ub,dim,fobj] = Get_Functions_IHGS(F,DimValue)
...
function o = F24(x)
     ...
     filename = 'C:\Users\Administrator\Desktop\XI-2\data\PD-TVFEMD-BDX.csv';
     delimiter = ',';
     startRow = 2;
     ...
     fclose(fileID);
     PDTVFEMDBDX1 = [dataArray{1:end-1}];
     clearvars filename delimiter startRow formatSpec fileID dataArray ans;
     o=x(1)*PDTVFEMDBDX1(:,1)+x(2)*PDTVFEMDBDX1(:,2)+x(3)*PDTVFEMDBDX1(:,3)+x(4)*PDTVFEMDBDX1(:,4)+x(5)*PDTVFEMDBDX1(:,5)-PDTVFEMDBDX1(:,6);
end